...
CORE = script.Parent.Parent.Parent.Parent.Parent.Core
...
if (script.Parent.Text == tostring(game.Workspace["MAIN.VALUES"].CORECODE.Value)) then
print("Accepted")
...
script.Parent.Parent.Parent.Parent.Parent.Core.Core.MainframeLift:Play()
for i=1,50 do
CORE:SetPrimaryPartCFrame(CORE.PrimaryPart.CFrame * CFrame.new(0, 0.5, 0))
wait()
end
script.Parent.Parent.Parent.Parent.Parent.Core.Core.MainframeLift.TimePosition = 8
wait(3)
CORE.KEYPADS.KeyPad2.SurfaceGui.Enabled = true
CORE.KEYPADS.KeyPad2.SurfaceGui.Frame.SCREEN.Script.Disabled = false
--------------------------------------------------------------------
for i=0x1,#LIFTCHILD do
	LIFTCHILD[i].Color = Color3.fromRGB(52, 176, 7)
end
--------------------------------------------------------------------
CORE.KEYPADS.KeyPad2.SurfaceGui.Startup.Visible = true
CORE.KEYPADS.KeyPad2.SurfaceGui.Startup.Startup1.Visible = true
wait(1)
CORE.KEYPADS.KeyPad2.SurfaceGui.Startup.Startup1.Visible = false
CORE.KEYPADS.KeyPad2.SurfaceGui.Startup.Startup2.Visible = true
wait(1)
CORE.KEYPADS.KeyPad2.SurfaceGui.Startup.Visible = false
CORE.KEYPADS.KeyPad2.SurfaceGui.Startup.Startup1.Visible = true
CORE.KEYPADS.KeyPad2.SurfaceGui.Startup.Startup2.Visible = false
--------------------------------------------------------------------
CORE.KEYPADS.KeyPad2.SurfaceGui.Frame.Visible = true
--------------------------------------------------------------------
for i=8,1,-1 do
	wait(3)
...
--------------------------------------------------------------------
CORE.KEYPADS.KeyPad2.SurfaceGui.Enabled = false
CORE.KEYPADS.KeyPad2.SurfaceGui.Frame.Visible = false
wait(2)
for i=1,50 do
CORE:SetPrimaryPartCFrame(CORE.PrimaryPart.CFrame * CFrame.new(0, -0.5, 0))
wait()
