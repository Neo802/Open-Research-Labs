...
while true do
	wait()
	script.Parent.TEMP.FRAME.Size = UDim2.new(1, 0, -(game.Workspace.Temp.Current.Value/max.Value)/2, 0)
	...
	script.Parent.TemperatureFrame.TextLabel.Script.Disabled = false
    script.Parent.TEMP.FRAME.BackgroundColor3 = Color3.fromRGB(112, 230, 230)
    
    elseif game.Workspace.Temp.Current.Value >= -3999 and game.Workspace.Temp.Current.Value <=-3000 then
	script.Parent.TemperatureFrame.TextLabel.Script.Disabled = false
    script.Parent.TEMP.FRAME.BackgroundColor3 = Color3.fromRGB(74, 183, 230)


    elseif game.Workspace.Temp.Current.Value >= 4000 or game.Workspace.Temp.Current.Value <= -4000 then
    if game.Workspace.Temp.Current.Value >= 4000 then
    script.Parent.TEMP.FRAME.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    elseif game.Workspace.Temp.Current.Value <= -4000 then
	script.Parent.TEMP.FRAME.BackgroundColor3 = Color3.fromRGB(74, 183, 230)
    end
