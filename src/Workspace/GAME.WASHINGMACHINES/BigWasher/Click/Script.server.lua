...
script.Parent.CD.MouseClick:connect(function()
	...
	wait(3)
	script.Parent.Parent.GUI.SurfaceGui.Status.Text = "Washing Speed = 30"
	script.Parent.Parent.Motor.FrontParamB = 1
	wait(3)
	script.Parent.Parent.GUI.SurfaceGui.Status.Text = "Washing Speed = 50"
	script.Parent.Parent.Motor.FrontParamB = 4
	wait(3)
	script.Parent.Parent.GUI.SurfaceGui.Status.Text = "Washing Speed = 100"
	script.Parent.Parent.Motor.FrontParamB = 10
	wait(1)
